...
class LinearNetworkFORCEModel(inverse.InverseModel):
    """Linear Network with FORCE (RLS type) learning rule"""

    name = "LN-FORCE"
    desc = "Linear Network with FORCE (RLS type) learning rule"

    def __init__(self, dim_x, dim_y, fmodel, **kwargs):
        print("lnforce init", dim_x, dim_y, fmodel, kwargs)
        self.dim_x = dim_x
        self.dim_y = dim_y
